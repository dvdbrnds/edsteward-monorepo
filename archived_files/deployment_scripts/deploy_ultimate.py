...
def deploy_ultimate():
    ...
    try:
        ...
        # Use the ultimate fix image
        ultimate_image = '259661441422.dkr.ecr.us-east-1.amazonaws.com/edsteward-repo:ultimate-fix-1750033806'
        
        print(f"🚀 Deploying ULTIMATE FIX: {ultimate_image}")
        ...
        for container in task_def['containerDefinitions']:
            ...
            if container['name'] == 'edsteward-app':
                new_container['image'] = ultimate_image
        ...
        print("⏳ Waiting for ultimate deployment...")
        ...
        for i in range(15):
            ...
            if primary_deployment:
                ...
                if running_count == desired_count and new_task_arn in current_task_def:
                    print("✅ ULTIMATE DEPLOYMENT COMPLETED!")
                    
                    # Test the fix
                    print("🧪 Testing the ultimate fix...")
                    time.sleep(15)
