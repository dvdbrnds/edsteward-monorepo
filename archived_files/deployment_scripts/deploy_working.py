...
def deploy_working():
    """Deploy the working image"""
    try:
        ecs = boto3.client('ecs', region_name='us-east-1')
        
        # Use the working image
        working_image = '259661441422.dkr.ecr.us-east-1.amazonaws.com/edsteward-repo:working-1750032830'
        
        print(f"🚀 Deploying working image: {working_image}")
        ...
        for container in task_def['containerDefinitions']:
            ...
            if container['name'] == 'edsteward-app':
                new_container['image'] = working_image
