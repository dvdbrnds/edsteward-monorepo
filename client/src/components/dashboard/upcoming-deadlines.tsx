  ...
  return (
    <Card>
      ...
      <CardContent className="pb-4">
        <div className="space-y-2 max-h-[450px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 hover:scrollbar-thumb-gray-400 pr-3">
