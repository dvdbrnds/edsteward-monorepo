        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-foreground">EdSteward Admin Console</h1>
                <p className="text-sm text-muted-foreground">System Administration & Tenant Management</p>
              </div>
            </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="text-center">
                          <div className="text-lg font-bold text-secondary">{tenant.userCount}</div>
                          <div className="text-xs text-muted-foreground">Users</div>
                        </div>
                        <div className="text-center">
                          <div className="text-lg font-bold text-secondary">{tenant.regulationCount}</div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge className="bg-primary/10 text-primary">4 features</Badge>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm">API & Backend</span>
                      <Badge className="bg-secondary/10 text-secondary">3 features</Badge>
                    </div>
                    <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Badge className="bg-accent/10 text-accent">3 features</Badge>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm">Administration</span>
                      <Badge className="bg-secondary/10 text-secondary">2 features</Badge>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Badge className="bg-secondary/10 text-secondary">Running</Badge>
                    </div>
                    <div className="flex items-center justify-between">
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Badge className="bg-secondary/10 text-secondary">Current</Badge>
                    </div>
                  </div>
                </CardContent>
              </Card>
