...
COPY public.comments (id, regulation_id, user_id, content, parent_id, created_at) FROM stdin;
\.
...
COPY public.deadlines (id, regulation_id, due_date, status, assigned_to) FROM stdin;
791	4461	2025-10-01	