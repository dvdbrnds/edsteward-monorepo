/**
 * Auto-generated config for: Accreditation Requirements
...
window.REGULATION_SLUG = 'accreditation-requirements';
window.REG_KEY = 'REG-XXX';
window.JURISDICTION_SOURCE = 'federal';
window.STATE_CODE = '';
window.ENFORCING_AGENCY = '';
window.REGULATION_NAME = 'Accreditation Requirements';

window.REGULATION_CONFIG = {
  id: 'accreditation-requirements',
  name: 'Accreditation Requirements',
