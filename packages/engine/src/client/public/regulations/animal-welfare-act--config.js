/**
 * Auto-generated config for: Animal Welfare Act
...
window.REGULATION_SLUG = 'animal-welfare-act';
window.REG_KEY = 'REG-079';
window.JURISDICTION_SOURCE = 'federal';
window.STATE_CODE = '';
window.ENFORCING_AGENCY = '';
window.REGULATION_NAME = 'Animal Welfare Act';

window.REGULATION_CONFIG = {
  id: 'animal-welfare-act',
