/**
 * Auto-generated config for: Controlled Substances Act
...
window.REGULATION_SLUG = 'controlled-substances-act';
window.REG_KEY = 'REG-102';
window.JURISDICTION_SOURCE = 'federal';
window.STATE_CODE = '';
window.ENFORCING_AGENCY = '';
window.REGULATION_NAME = 'Controlled Substances Act';

window.REGULATION_CONFIG = {
  id: 'controlled-substances-act',
