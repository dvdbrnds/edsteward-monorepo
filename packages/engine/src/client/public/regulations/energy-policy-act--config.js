/**
 * Auto-generated config for: Energy Policy Act
...
window.REGULATION_SLUG = 'energy-policy-act';
window.REG_KEY = 'REG-132';
window.JURISDICTION_SOURCE = 'federal';
window.STATE_CODE = '';
window.ENFORCING_AGENCY = '';
window.REGULATION_NAME = 'Energy Policy Act';

window.REGULATION_CONFIG = {
  id: 'energy-policy-act',
