/**
 * Auto-generated config for: Equal Employment Opportunity
...
window.REGULATION_SLUG = 'equal-employment-opportunity';
window.REG_KEY = 'REG-073';
window.JURISDICTION_SOURCE = 'federal';
window.STATE_CODE = '';
window.ENFORCING_AGENCY = '';
window.REGULATION_NAME = 'Equal Employment Opportunity';
