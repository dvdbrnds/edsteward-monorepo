/**
 * Auto-generated config for: Financial Aid Administration
...
window.REGULATION_SLUG = 'financial-aid-administration';
window.REG_KEY = 'REG-XXX';
window.JURISDICTION_SOURCE = 'federal';
window.STATE_CODE = '';
window.ENFORCING_AGENCY = '';
window.REGULATION_NAME = 'Financial Aid Administration';

window.REGULATION_CONFIG = {
  id: 'financial-aid-administration',
