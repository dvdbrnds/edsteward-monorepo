/**
 * Auto-generated config for: Higher Education Act Audits
...
window.REGULATION_SLUG = 'higher-education-act-audits';
window.REG_KEY = 'REG-023';
window.JURISDICTION_SOURCE = 'federal';
window.STATE_CODE = '';
window.ENFORCING_AGENCY = '';
window.REGULATION_NAME = 'Higher Education Act Audits';

window.REGULATION_CONFIG = {
  id: 'higher-education-act-audits',
  name: 'Higher Education Act Audits',
