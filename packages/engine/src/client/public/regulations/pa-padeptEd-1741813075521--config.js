/**
 * Auto-generated config for: Pa PadeptEd 1741813075521
...
window.REGULATION_SLUG = 'pa-padeptEd-1741813075521';
window.REG_KEY = 'REG-XXX';
window.JURISDICTION_SOURCE = 'federal';
window.STATE_CODE = '';
window.ENFORCING_AGENCY = '';
window.REGULATION_NAME = 'Pa PadeptEd 1741813075521';

window.REGULATION_CONFIG = {
  id: 'pa-padeptEd-1741813075521',
  name: 'Pa PadeptEd 1741813075521',
