/**
 * Auto-generated config for: Student Complaints Html
...
window.REGULATION_SLUG = 'student-complaints-html';
window.REG_KEY = 'REG-XXX';
window.JURISDICTION_SOURCE = 'federal';
window.STATE_CODE = '';
window.ENFORCING_AGENCY = '';
window.REGULATION_NAME = 'Student Complaints Html';

window.REGULATION_CONFIG = {
  id: 'student-complaints-html',
  name: 'Student Complaints Html',
