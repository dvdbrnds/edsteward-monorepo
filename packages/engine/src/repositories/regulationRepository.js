    ...
    try {
      ...
      const result = await client.query(`
        ...
        ON CONFLICT (item_id) DO UPDATE SET
          ...
          jurisdiction_source = COALESCE(EXCLUDED.jurisdiction_source, regulations.jurisdiction_source),
          state_code = COALESCE(EXCLUDED.state_code, regulations.state_code),
